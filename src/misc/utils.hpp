...
#define TBD_LOG_VK(msg) std::cout << "[LOG VK]: " << msg << _TBD_ENDLOG
#define TBD_WARN(msg) std::cerr << "\033[93m[WARNING]: " << msg << _TBD_ENDLOG
#define TBD_WARN_VK(msg) std::cerr << "\033[93m[WARNING VK]: " << msg << _TBD_ENDLOG
#define TBD_ERROR(msg) std::cerr << "\033[31m[ERROR]: " << msg << _TBD_ENDLOG
#define TBD_ERROR_VK(msg) std::cerr << "\033[31m[ERROR VK]: " << msg << _TBD_ENDLOG

#ifdef PROJECT_DEBUG
#define TBD_DEBUG(msg) std::cout << "\033[96m[DEBUG]: " << msg << _TBD_ENDLOG
#define TBD_DEBUG_VK(msg) std::cout << "\033[96m[DEBUG VK]: " << msg << _TBD_ENDLOG
#else
...
#define _TBD_FATAL_VK(msg) std::cerr << "\033[31m[FATAL VK]: " << msg << _TBD_ENDLOG
